...
public class Main extends JFrame {
    ...
    // Model chứa dữ liệu của từng sản phẩm
    ...
    // Các biến phục vụ cho hiệu ứng chuyển ảnh (Animation)
    private BufferedImage oldImage;
    private BufferedImage newImage;
    private float alpha = 1.0f;
    private Timer animationTimer;
    
    // Các thành phần UI bên trái
    ...
    public Main() {
        setTitle("Lab 03 - Product Store Layout");
    ...
    // Tải thông tin và hình ảnh sản phẩm
    ...
    private JPanel createProductCard(int index) {
        ...
        JPanel card = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Nền thẻ màu xám nhạt
                g2.setColor(new Color(242, 243, 244)); 
                g2.fillRoundRect(0, 0, getWidth() - 1, getHeight() - 1, 15, 15);
                
                // Viền xanh nếu đang được chọn
                if (selectedIndex == index) {
                    g2.setColor(new Color(100, 150, 255)); // Viền xanh dương
        ...
        card.setOpaque(false); // Để thấy các góc bo tròn
        card.setCursor(new Cursor(Cursor.HAND_CURSOR));
        
        // --- Phần chữ phía trên (Title & Subtitle) ---
        ...
        // --- Phần chữ phía dưới (Brand & Price) ---
    ...
    // Cập nhật thông tin bên trái khi một card được click
